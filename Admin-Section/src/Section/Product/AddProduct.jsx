...
const AddProduct = () => {
  ...
  return (
    <div className="bg-white p-10 rounded-xl w-full max-w-2xl mx-auto mt-10 shadow-md">
      <h1 className="text-center text-4xl text-green-600 font-semibold mb-10">Add Product</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-center gap-10 mt-10">
          <button type="submit" className="green-btn px-6 py-2 text-white text-lg font-semibold">
            Submit
          </button>
          <Link to="/" className="red-btn px-6 py-2 text-white text-lg font-semibold">
            Cancel
          </Link>
        </div>
      </form>
