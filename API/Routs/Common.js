...
import { offerDisplay } from "../Controllers/common/offer.js";
import { displayAllProduct, displayByCategory, searchItems, searchItemsByID } from "../Controllers/common/product.js";
...
commonRouter.get("/searchProductByID/:id", searchItemsByID);
