    ...
    <>
      {token ?
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="mt-10">
                      {response ? <p className="text-green-600 font-bold text-lg ">{response}</p> : <p className="text-red-600 font-bold text-lg">{error}</p>}
                    </div>
                  </form>
                </div>
                {/* <CreditCard /> */}
              ...
              <div>
                ...
                <div className=" border-t pt-4 py-4">
                  ...
                  <p className="flex justify-between py-2 mt-5">
                    <span>Amount Quantity:</span> <span>{totalQuatity | 0}</span>
                  </p>
                  <hr className="my-4 border-gray-300" />
        ...
        <div className="flex flex-wrap gap-20 justify-center items-center py-36">
          <Link to='/auth/signup'><button className="w-[200px] font-bold text-xl p-3 bg-green-600 hover:bg-green-500 text-white rounded transition-all duration-300 text-center">Create Account</button></Link>
          <Link to='/auth/login'><button className="w-[150px] font-bold text-xl p-3 bg-green-600 hover:bg-green-500 text-white rounded transition-all duration-300 text-center">Log In</button></Link>
        </div>
